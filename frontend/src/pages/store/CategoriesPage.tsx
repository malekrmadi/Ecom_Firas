...
const CategoriesPage: React.FC = () => {
  ...
  // Dynamically calculate max price for the slider
      ...
      <div className="categories-page py-12">
        <div className="container">
          <div className="categories-page-header mb-12">
            <h1 className="text-4xl lg:text-5xl font-bold">Catalog</h1>
            <p className="text-muted mt-2">Explore our collection of premium tunisian products.</p>
          </div>
            ...
            <aside className="filters-sidebar space-y-10 order-2 lg:order-1">
              <div className="filter-section p-6 bg-gray-50 rounded-2xl border border-gray-100">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h4 className="m-0 font-bold">Filters</h4>
                </div>
                
                <div className="space-y-8">
                  <div className="filter-group">
                    <label className="block text-sm font-bold uppercase tracking-wider mb-3 text-gray-500">Search</label>
                  ...
                  <div className="filter-group">
                    <div className="flex justify-between mb-3">
                      <label className="text-sm font-bold uppercase tracking-wider text-gray-500">Max Price</label>
                      <span className="font-bold text-primary">{maxPrice} TND</span>
                    </div>
                    <input 
                      type="range" 
                      min="0" 
                    ...
                    <div className="flex justify-between mt-2 text-xs text-muted font-medium">
                      <span>0 TND</span>
                      <span>{absoluteMaxPrice} TND</span>
                    </div>
                  </div>
                  ...
                  <div className="filter-group">
                     <label className="flex items-center gap-3 cursor-pointer group">
                        ...
                        <span className="font-bold text-gray-700 group-hover:text-primary transition-colors">In Stock Only</span>
                     </label>
                  </div>
                </div>
