...
const navItems = [
  ...
  { path: "/admin/agent", label: "MyStore Agent", icon: "M12 2a2 2 0 012 2v1a2 2 0 01-2 2 2 2 0 01-2-2V4a2 2 0 012-2zM6.5 7A2.5 2.5 0 004 9.5v7A2.5 2.5 0 006.5 19h11a2.5 2.5 0 002.5-2.5v-7A2.5 2.5 0 0017.5 7h-11zM9 11a1 1 0 112 0 1 1 0 01-2 0zm4 0a1 1 0 112 0 1 1 0 01-2 0zM9 15h6" },
  ...
  { path: "/admin/returns", label: "Retours", icon: "M20 12h-4M4 12H0m12 0c0-4.418-3.582-8-8-8s-8 3.582-8 8 3.582 8 8 8 8-3.582 8-8zM12 12c0 2.21 1.79 4 4 4s4-1.79 4-4-1.79-4-4-4-4 1.79-4 4z" },
